<template>
  <empty>
    <header class="py-6">
      <div
        class="container flex items-center justify-between w-full px-8 mx-auto md:px-14 lg:px-24"
      >
        ...
        <div class="items-center hidden space-x-12 md:flex">
          <a
            ...
            :key="index"
            :href="navigator.link"
            :class="{ 'text-selected-text': index === 0 }"
          >
            {{ index < 3 ? navigator.text : "" }}
            <button v-if="index === 3" class="px-6 py-2 font-bold bg-theme">
              {{ navigator.text }}
            </button>
          </a>
        </div>
    ...
    <div
      class="container flex items-center justify-between w-full px-8 mx-auto mt-16 md:px-14 lg:px-24"
    >
      <div class="flex flex-wrap md:flex-nowrap">
        <nav
          class="fixed hidden inline-block lg:mr-24 lg:w-4 left-percentage xl:block"
        >
          <div
        ...
        <div
          class="flex flex-wrap justify-center max-w-xl mt-0 lg:ml-20 md:justify-start md:my-36"
        >
          <h1
            class="text-5xl font-bold text-center md:text-6xl lg:text-7xl md:text-left"
          >
            Building<br />
          ...
          <div class="flex justify-center w-full md:justify-start">
            <button
              class="flex items-center px-8 py-4 mt-12 space-x-3 font-bold text-white bg-theme"
            >
              <div>
                <svg
                  width="22"
        ...
        <img
          src="./assets/man.png"
          alt="Man"
          class="right-0 w-3/4 mt-12 md:absolute md:mt-0 -z-1"
        />
      </div>
    </div>
    ...
    <!-- My work -->
    <div
      class="container flex items-center justify-between w-full px-8 mx-auto mt-64 md:px-14 lg:px-24"
    >
    ...
    >
      <section class="w-full">
        ...
        <div class="grid w-full gap-8 mt-24 lg:grid-cols-2 lg:gap-32">
          <div class="space-y-12">
            <div>
              <label class="block mb-6 text-xl font-bold text-white"
                >Name</label
              >
              <input
                class="w-full px-4 py-4 border border-input-border bg-input"
              />
            </div>
            <div>
              <label class="block mb-6 text-xl font-bold text-white"
            ...
            <div>
              ...
              <textarea
                type="email"
                class="w-full h-56 px-4 py-4 border resize-none border-input-border bg-input"
              ></textarea>
            </div>
            <button class="px-6 py-2 font-bold text-white bg-theme">
              Send it!
            </button>
          </div>
